...
public class OrderDetailsActivity extends AppCompatActivity {
    ...
    private TextView totalItems,totalItemsPrice, consultationPrice,totalAmount,savedAmount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  cancelDialog.getWindow().setLayout(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        consultationPrice = findViewById(R.id.consultation_price);
        ...
        switch (model.getShiftingStatus()){
        ...
        if(model.isCancellationRequested()){
            ...
            if(model.getShiftingStatus().equals("Ordered") || model.getShiftingStatus().equals("Shipped")){
                cancelOrderBtn.setVisibility(View.VISIBLE);
        ...
        if(model.getConsultationPrice().equals("FREE")){
            consultationPrice.setText(model.getConsultationPrice());
            totalAmount.setText(totalItemsPrice.getText());
        }else {
            consultationPrice.setText("Rs." +model.getConsultationPrice()+"/-");
            totalAmount.setText("Rs."+(totalItemsPriceValue+Long.valueOf(model.getConsultationPrice()))+"/-");
        }
