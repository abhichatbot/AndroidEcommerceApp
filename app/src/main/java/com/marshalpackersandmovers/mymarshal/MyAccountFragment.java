            ...
            public void onDismiss(DialogInterface dialog) {
                for (MyOrderItemModel orderItemModel : DBqueries.myOrderItemModelList) {
                    if (!orderItemModel.isCancellationRequested()) {
                        if (!orderItemModel.getShiftingStatus().equals("Delivered") && !orderItemModel.getShiftingStatus().equals("Cancelled")) {
                            ...
                            tvCurrentOrderStatus.setText(orderItemModel.getShiftingStatus());

                            switch (orderItemModel.getShiftingStatus()) {
                                case "Ordered":
                ...
                for (MyOrderItemModel myOrderItemModel : DBqueries.myOrderItemModelList) {
                    if (i < 4) {
                        if (myOrderItemModel.getShiftingStatus().equals("Delivered")) {
